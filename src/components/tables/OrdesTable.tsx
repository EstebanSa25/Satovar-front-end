                    ...
                    <tbody>
                        {orders.map((order: OrderApiInterface) => (
                            ...
                            >
                                ...
                                <td>{order.T_COMPRA.T_USUARIO.CV_NOMBRE}</td>
                                <td>{order.T_COMPRA.T_USUARIO.CV_APELLIDO1}</td>
                                <td>{order.T_COMPRA.T_USUARIO.CV_TELEFONO}</td>
                                <td>{order.T_COMPRA.T_USUARIO.CV_DIRECCION}</td>
                                ...
                                <td>
                                    <select
                                        onChange={(e) =>
                                            onInputChange(e, order.CI_ID_PEDIDO)
                                        }
